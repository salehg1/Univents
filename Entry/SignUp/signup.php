...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (empty($fullname)) {
        ...
        if (!is_wp_error($user_id)) {
            ...
            update_user_meta($user_id, 'major', 'General');
...
<form class="login-form" method="post" novalidate>
  ...
  <h2 class="login-title" data-translate="createAccountTitle">
    إنشاء حساب جديد
  </h2>

  <p class="welcome-text" data-translate="signupDesc">
    يرجى تعبئة البيانات التالية لإنشاء حسابك الجامعي
  </p>
  ...
  <input
    ...
    data-translate-placeholder="studentName"
    maxlength="60"
  ...
  <input
    ...
    data-translate-placeholder="studentId"
    value="<?= htmlspecialchars($values['student_id']) ?>"
    required
  >
  ...
  <input
    ...
    data-translate-placeholder="confirmPasswordPlaceholder"
    required
  >

  <button type="submit" class="btn-login" data-translate="createAccountButton">
    إنشاء الحساب
  </button>

  <div class="links">
    <a href="../LogIn/login.php" data-translate="backToLogin">
      عودة لتسجيل الدخول
    </a>
  </div>
